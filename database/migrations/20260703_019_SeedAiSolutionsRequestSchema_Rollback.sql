...
-- Description: Rollback for 20260703_019_SeedAiSolutionsRequestSchema. Removes the
--              seeded Request field schema (and its children) from the AI Solutions
--              workspace. Children are removed before their FieldDefinition parents.
--              Idempotent.
-- =============================================
...
BEGIN TRY
    ...
    DELETE FROM dbo.MigrationHistory WHERE MigrationId = N'20260703_019_SeedAiSolutionsRequestSchema';
