...
-- Description: Rollback for 20260703_024_CreateGateDefinition. Idempotent. Drops the
--              gate slots (which reference gates) first if present.
-- =============================================
...
DELETE FROM dbo.MigrationHistory WHERE MigrationId = N'20260703_024_CreateGateDefinition';
GO
