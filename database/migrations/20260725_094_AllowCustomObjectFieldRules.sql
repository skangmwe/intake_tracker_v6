...
IF NOT EXISTS (SELECT 1 FROM dbo.MigrationHistory WHERE MigrationId = N'20260725_094_AllowCustomObjectFieldRules')
BEGIN
    INSERT INTO dbo.MigrationHistory (MigrationId, AppliedBy, Description)
    VALUES (N'20260725_094_AllowCustomObjectFieldRules', SUSER_SNAME(),
