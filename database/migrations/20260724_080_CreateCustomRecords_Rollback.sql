...
-- Description: Rollback for 20260724_080_CreateCustomRecords — drops the table (indexes and
...
DELETE FROM dbo.MigrationHistory WHERE MigrationId = N'20260724_080_CreateCustomRecords';
GO
