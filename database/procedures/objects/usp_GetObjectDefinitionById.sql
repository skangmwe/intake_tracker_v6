...
--              Location='Global') is resolvable from any calling workspace. The Global arm requires
--              WorkspaceId IS NULL (not Location alone) so a workspace-owned row mislabelled
--              Location='Global' stays scoped to its own workspace and never leaks cross-tenant.
-- =============================================
